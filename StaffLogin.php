...
<h1 style="text-align: center; color:#ffffff"><u>Staff Login (For management of rooms)</u></h1>

<img src="images/simlogo.png" alt="SIM" class="center">

<form method="post" action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    <fieldset class="center">
        <legend><b><h2><i class="fa-solid fa-school"></i> Staff Login</h2></b></legend>
        <div>
    ...
    <a href="StudentLogin.php" style="float: right;">Go to Student Login</a><br><!-- comment -->
